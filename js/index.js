        ...
        Swal.fire({
            html: `
                <form class="p-2 text-start" id="formularioModal">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="notasInput" rows="3" placeholder="Descripción de la tarea..."></textarea>
                    </div>
                </form>
            `,
            ...
            if (resultado.isConfirmed) {
                ...
                Swal.mixin({
                    ...
                    icon: "success",
                    title: `Tarea "${datosTarea.titulo}" agregada`
                });
            }
        });
    });
